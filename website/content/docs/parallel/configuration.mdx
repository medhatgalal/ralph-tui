...
[parallel.conflictResolution]
enabled = true                          # Enable AI-powered conflict resolution
timeoutMs = 120000                      # Timeout for AI per file (ms)
```
...
| `conflictResolution.enabled` | boolean | `true` | Enable automated AI resolution for merge conflicts |
| `conflictResolution.timeoutMs` | number | `120000` | Timeout in milliseconds for AI resolution per file |
